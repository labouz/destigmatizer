...
def get_destigma_style(post, explanation, style_instruct, step, retries = 2, model = "gpt-4-turbo-2024-04-09", openai_client=None):
    ...
    # print(f"Post: {post}, Type: {type(post)}")
    # print(f"Explanation: {explanation}, Type: {type(explanation)}")
    # print(f"Style Instruction: {style_instruct}, Type: {type(style_instruct)}")
